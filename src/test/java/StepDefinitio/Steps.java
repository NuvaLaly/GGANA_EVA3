...
public class Steps {
	...
	WebDriver driver;
	 ...
	 public void abrir_Chrome() {
		 ...
		 driver.get("http://localhost:8080/JSF_Hibernate_loginProject_1/");
	}
	 
	 @When("ingresar user_name {string} y password {string}")
	 public void ingresar_username_y_password(String string, String string2) {
		 ...
		 driver.findElement(By.id("user_name")).sendKeys(string);
